...
/**
 * Clase para modificar solo un cliente de nuestra APP
 *
 * @author Moisés López Vega
 */
public class modificarSoloCliente extends javax.swing.JDialog {
     ...
     */
    public modificarSoloCliente(java.awt.Frame parent, boolean modal, int n_index) {
        ...
        botonGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(modificarSoloCliente.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    private void cargarCliente(cliente cliente) {
        ...
        jComboBoxFP.setSelectedItem(cliente.getFormaPago());
...
// Método auxiliar para verificar si una cadena es numérica
    ...
    private void compruebaSalir() {
        ...
        if (hayDatos) {
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                modificarSoloCliente.this.dispose();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarSoloCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                modificarSoloCliente dialog = new modificarSoloCliente(new javax.swing.JFrame(), false, 0);
