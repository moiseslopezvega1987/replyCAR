...
/**
 * Clase para modificar los proveedores de nuestra APP
 *
 * @author Moisés López Vega
 */
public class modificarProveedores extends javax.swing.JDialog {
     ...
     */
    public modificarProveedores(java.awt.Frame parent, boolean modal) {
        ...
        // Agregar MouseListener a jLabelDerecha para ir al Proveedor posterior
        jLabelDerecha.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (proveedorIndex < proveedores.size() - 1) {
                    proveedorIndex++;
                    cargarProveedor(proveedores.get(proveedorIndex));
                }
            }
        ...
        // Agregar MouseListener a jLabelIzquierda para ir al Proveedor anterior
    ...
    private void cargarProveedor(proveedor proveedor) {
        ...
        idFormaPagoCajaTexto.setText(Integer.toString(proveedor.getFormaPago()));
        jComboBoxFP.setSelectedIndex(proveedor.getFormaPago() - 1);
...
// Método auxiliar para verificar si una cadena es numérica
    ...
    private void initComponents() {
        ...
        botonBuscar.setToolTipText("Pincha para buscar el proveedor insertado");
        ...
        jTextFieldBuscar.setToolTipText("Ingresa nº de proveedor a buscar");
        ...
        jLabelNcliente2.setText("(Nº proveedor):");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(jLabelNcliente2, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        if (texto.isEmpty() || !isNumeric(texto)) {
            ...
            proveedorIndex = Integer.parseInt(texto);
            // Obtiene la última ID registrada para verificar que la búsqueda está dentro del rango
            int ultimaID = proveedorDAO.obtenerUltimaID();
            // Comprueba si el número introducido está fuera del rango permitido
            if (proveedorIndex < 1 || proveedorIndex > ultimaID) {
                JOptionPane.showMessageDialog(null, "Número de proveedor no válido.", "Error en la búsqueda", JOptionPane.ERROR_MESSAGE);
                // Marca el campo como erróneo
                jTextFieldBuscar.setBackground(Color.RED);
                esValido = false;
            }
            // Si el número es válido, carga los datos del proveedor correspondiente
            if (esValido) {
                // Se obtiene el proveedor desde la lista (index - 1 porque la lista empieza en 0)
                cargarProveedor(proveedores.get(proveedorIndex - 1));
            }
    ...
    private void jTextFieldBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarKeyTyped
        ...
        // Máximo 4 caracteres para la busqueda del proveedor
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                modificarProveedores dialog = new modificarProveedores(new javax.swing.JFrame(), false);
