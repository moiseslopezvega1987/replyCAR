...
/**
 * Clase para añadir nuevos proveedores a nuestra APP
 *
...
public class nuevosProveedores extends javax.swing.JDialog {
    ...
    /**
     * Constructor del diálogo de nuevos proveedores
     *
     * @param parent el componente padre.
     * @param modal indica si el cuadro de diálogo es modal.
     */
    public nuevosProveedores(java.awt.Frame parent, boolean modal) {
        ...
        // Obtener siguiente ID de proveedor automáticamente
        proveedorDAO.obtenerSiguienteID(idCajaTexto);
        ...
        botonGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(nuevosProveedores.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        maestros.consultarAyuda(jLabelAyuda, "nuevos_proveedores");
    ...
    private void guardarProveedorActionPerformed(ActionEvent evt) throws SQLException {
        ...
        try {
            ...
            // Comprueba CIF para formasPago jurídicos
            if (jRadioButtonJuridica.isSelected()) {
            ...
            // Comprueba DNI para formasPago físicos
            if (jRadioButtonFisica.isSelected()) {
            ...
            if (esValido) {
                ...
                JOptionPane.showMessageDialog(null, "Proveedor guardado Correctamente.", "Todo ha ido bien", JOptionPane.INFORMATION_MESSAGE);
                resetearFormulario();
            } else {
    ...
    private void resetearFormulario() {
        ...
        this.proveedorDAO.obtenerSiguienteID(idCajaTexto);
    ...
    private void compruebaSalir() {
        ...
        if (hayDatos) {
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                nuevosProveedores.this.dispose();
            } else {
    ...
    private void initComponents() {
        ...
        setTitle("ReplyCar - Nuevo Proveedor");
        ...
        jLabelTitulo.setText("Nuevo Proveedor");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(131, 131, 131))
                                    .addComponent(jLabelNcliente, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        botonGuardar.setText("Guardar Nuevo Proveedor");
        botonGuardar.setToolTipText("Pincha para guardar el nuevo proveedor");

        idFormaPagoCajaTexto.setFont(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        idFormaPagoCajaTexto.setEnabled(false);
        idFormaPagoCajaTexto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
    ...
    private void txtNClienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNClienteKeyTyped
        ...
        idFormaPagoCajaTexto.setBackground(Color.WHITE);
        // Si el ID supera los 4 caracteres, no permite seguir escribiendo
        if (idFormaPagoCajaTexto.getText().length() > 4) {
            evt.consume();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuevosProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nuevosProveedores dialog = new nuevosProveedores(new javax.swing.JFrame(), false);
